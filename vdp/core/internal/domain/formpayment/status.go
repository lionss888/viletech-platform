...
const (
	...
	StatusReturnReported                       Status = "return_reported"
	StatusReturnAwaitingClientClarify          Status = "return_awaiting_client_clarify"
	StatusReturnMgrDecision                    Status = "return_mgr_decision"
	StatusClientReturnConsentPending           Status = "client_return_consent_pending"
	StatusClientReturnRefused                  Status = "client_return_refused"
	StatusMgrReturnToClientReadyExecute        Status = "mgr_return_to_client_ready_execute"
	StatusReturnToClientClosed                 Status = "return_to_client_closed"
	StatusProvReturnRepeatExecuting            Status = "prov_return_repeat_executing"
	StatusReturnRepeatClosed                   Status = "return_repeat_closed"

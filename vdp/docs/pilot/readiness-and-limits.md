...
Оценка около **55–60%** для **app FE↔API** (W0–W6 foundation re-executed; RD partial). Backend R0–R12 ~82–85% на уровне API. Интеграции hub/staging и полный browser matrix — оговорки.

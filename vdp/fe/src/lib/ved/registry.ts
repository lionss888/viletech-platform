...
export const REGISTRIES: Record<RegistryKey, RegistryDef> = {
  organizations: {
    ...
    autoId: true,
    fields: [
      { key: "name", label: "Название организации", type: "text", required: true, placeholder: 'ООО "Северный Импорт"', hint: "Полное наименование, как в учредительных документах." },
      { key: "inn", label: "ИНН", type: "text", required: true, mono: true, placeholder: "7701234567", hint: "10 цифр для юридического лица, 12 — для ИП. Нужен для проверки комплаенс." },
      { key: "legalAddress", label: "Юридический адрес", type: "text", placeholder: "г. Москва, ул. Тверская, 1", hint: "Адрес регистрации из ЕГРЮЛ." },
      { key: "country", label: "Страна", type: "text", placeholder: "RU", hint: "Двухбуквенный код страны регистрации, например RU." },
      {
        key: "status",
        ...
        hint: "«Ожидает проверки» — комплаенс ещё не подтвердил организацию. До одобрения она подсвечивается в заявках.",
      },
    ],
  },
  counterparties: {

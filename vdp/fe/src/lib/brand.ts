 ...
 */
export const BRAND_FAVICON_SVG = "/viletech-mark.svg?v=20260906b";
export const BRAND_FAVICON_ICO = "/viletech-mark.ico?v=20260906b";
export const BRAND_FAVICON_PNG = "/viletech-mark.png?v=20260906b";

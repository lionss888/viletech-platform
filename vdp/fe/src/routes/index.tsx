...
import { BRAND_DOCUMENT, BRAND_MARK, BRAND_NAME } from "@/lib/brand";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: `${BRAND_DOCUMENT} — операционный контур платежей` },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: `${BRAND_DOCUMENT} — операционный контур платежей` },

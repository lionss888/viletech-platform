...
**Обязательны:** `планирование-сверка-с-rules`, `базовые-правила-инструмента`, `честность-готовности`, `ui-web-практики`, `ux-формы-навигация-онбординг`, `тесты-архитектуры`, `playwright-e2e`, `развертывание-и-доставка`, `devops-культура`, `безопасность-ролей-и-данных` (wipe только root/admin, без трогания учёток), `mgmt-tg-notify` (после gate волны).

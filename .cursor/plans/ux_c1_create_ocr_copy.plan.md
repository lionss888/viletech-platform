...
overview: 'Шаг 5 «Проверка»: сообщить, что документы распознаются; подпись у «Создать
  заявку» про фон и помощника Вэди. [status-sync 2026-09-24 completed] create-review-copy.ts
  + test + forms-new-page'
todos:
- id: c1-copy
...
## DoD
- [x] Тексты видны на шаге 5 при файлах
- [x] Нет ложного обещания vendor OCR
---

...
overview: "Восстановить сквозной путь Cursor-агента в vedy_bot (cloud SDK), не трогая rule-based HITL: устранить ops-блокеры, закрыть код-разрыв analyze→local stub, сделать fail честным."
todos:
  - id: w1-ops-env-up
...
# Почему агент / «реальная обработка» не работают

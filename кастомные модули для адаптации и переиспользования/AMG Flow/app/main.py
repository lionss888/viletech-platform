...
from app.api.v1.routes_ai_only import router as v1_router
...
# Create FastAPI app
app = FastAPI(
    title="Ollama BP Automation API",
    description="Ollama integration module for business process automation",
    version="0.1.0",
    lifespan=lifespan
)
...
async def root():
    """Root endpoint."""
    return {
        "message": "Ollama BP Automation API",
        "version": "0.1.0",
        "status": "running"
    }

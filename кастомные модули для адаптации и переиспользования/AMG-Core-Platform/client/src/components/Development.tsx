...
const Development: React.FC = () => {
  ...
  // Предустановленные запросы для разработки
  const developmentPrompts = [
    {
      title: "Код ревью",
      prompt: "Проведи код-ревью этого кода. Найди потенциальные проблемы, предложи улучшения и следуй лучшим практикам."
    },
    {
      title: "Рефакторинг",
      prompt: "Рефактори этот код для улучшения читаемости, производительности и поддерживаемости. Объясни изменения."
    },
    {
      title: "Оптимизация",
      prompt: "Оптимизируй этот код для лучшей производительности. Найди узкие места и предложи решения."
    },
    {
      title: "Архитектура",
      prompt: "Спроектируй архитектуру для этого проекта. Учти масштабируемость, безопасность и поддерживаемость."
    },
    {
      title: "Тестирование",
      prompt: "Напиши unit-тесты для этого кода. Покрой все основные сценарии и edge cases."
    },
    {
      title: "Документация",
      prompt: "Создай подробную документацию для этого API/функции. Включи примеры использования и описание параметров."
    },
    {
      title: "Отладка",
      prompt: "Помоги найти и исправить ошибку в этом коде. Проанализируй логи и предложи решения."
    },
    {
      title: "Безопасность",
      prompt: "Проведи аудит безопасности этого кода. Найди уязвимости и предложи способы их устранения."
    }
  ];
  ...
  const sendMessage = async (messageText?: string) => {
    ...
    try {
      const request = {
        ...
        convo_id: convoId,
        stream: true,
        system_prompt_type: 'development'
      };
      ...
      <div className="bg-white rounded-lg shadow-lg">
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-gray-800">AI Разработчик</h1>
        ...
        <div className="p-4 border-b border-gray-200 bg-gray-50">
          <h3 className="text-lg font-semibold mb-3">Быстрые задачи</h3>
            ...
            >
              ...
              >
                <div className="text-sm font-medium mb-1">
                  {message.role === 'user' ? 'Вы' : 'AI Разработчик'}
                </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex space-x-2">
            <textarea
              ...
              placeholder="Опишите задачу для разработки или вставьте код..."

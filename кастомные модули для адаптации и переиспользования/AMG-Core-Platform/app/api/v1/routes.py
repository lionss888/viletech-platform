"""API routes for v1 endpoints - DEPRECATED: Use routes_ai_only.py instead."""

# ВНИМАНИЕ: Этот файл содержит бизнес-логику и должен быть удален
# Вся бизнес-логика перенесена в Go backend
# Python используется только для AI/аналитики
...
# DEPRECATED: Этот роутер будет удален после переноса всей логики в Go

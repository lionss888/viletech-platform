...
@Controller('admin/compliance-officer/liquidity')
export class LiquidityComplianceOfficerController {
  constructor(@Inject('ILiquidityService') private readonly service: ILiquidityService) {}

  @Get('findOne')
  @ComplianceOfficerMethod({ response: { status: 200, type: LiquidityDto } })

-- Расширенные тестовые данные для АБС
...
-- Создание клиентов с разнообразными данными
...
-- Создание счетов с разнообразными типами и валютами
...
-- Создание разнообразных транзакций
...
-- Крупные транзакции для демонстрации
...
-- Обновление балансов на основе транзакций
